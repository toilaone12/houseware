...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h1 class="h3 mb-0 text-gray-800">Thêm phí vận chuyển</h1>
        </div>
        @php
            ...
            <div class="card w-100 bg-card">
                <div class="d-flex flex-wrap align-items-center mx-2">
                    <div class="col-5 mt-3">
                        <div class="h-100px">
                            <label for="radius" class="form-label">Khoảng cách (<span class="text-danger">*</span>) (<span class="radius-fee mr-1">1</span>km)</label>
                            <input type="range" class="form-range text-light range-radius" min="1" value="1" step="1" max="20" name="radius" id="radius">
                        </div>
                    </div>
                    ...
                    <div class="col-5 mt-3">
                        <div class="h-100px">
                            ...
                            <input type="phone" required name="fee" id="fee" class="form-control price-autonumberic">
                        </div>
                    </div>
                </div>
