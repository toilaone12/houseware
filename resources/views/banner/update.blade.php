...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h1 class="h3 mb-0 text-gray-800">Sửa quảng cáo</h1>
        </div>
        @php
            ...
            <div class="card w-100 bg-card">
                <div class="d-flex flex-wrap align-items-center mx-2">
                    <div class="col-lg-5 mt-3">
                        <input type="hidden" name="id" value="{{$one->id_banner}}">
                        <input type="hidden" name="image-old" value="{{$one->image}}">
                        <div class="h-100px">
                            <label for="image">Hình ảnh (<span class="text-danger">*</span>) <span
                                    class="file-intro text-info"></span></label>
                            <div class="input-group">
                                <input type="file" class="form-control choose-image" id="inputGroupFile04"
                                    accept="image/*" aria-describedby="inputGroupFileAddon04" name="image"
                                    aria-label="Upload">
                                <button class="btn btn-outline-secondary push-image" type="button" id="image">Tải
                                    lên</button>
                            </div>
                            @error('image')
